...
import { ThemeIcon, UnstyledButton, Group, Text, MantineTheme, CSSObject } from "@mantine/core";
...
function MainLink({ icon, color, label }: MainLinkProps): ReactNode {
  return (
    <UnstyledButton
...
export function MainLinks(): ReactNode {
